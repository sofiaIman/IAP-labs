...
<body>
	<form enctype="multipart/form-data" method="post" id="user_details" name="user_details" onsubmit="return validateForm()" action="<?=$_SERVER['PHP_SELF']?>">
		...
		<div><input type="text" name="city_name" placeholder="Enter city name"></div>
	...
	<table id="users-tab">
		<tr><th>ID</th><th>USERNAME</th><th>FIRST NAME</th><th>LAST NAME</th><th>CITY</th><th>UTC TIMESTAMP</th><th>OFFSET</th><th>PROFILE</th></tr>
	<?php 
